...
function Remove_displayNav(){
    document.querySelector('.Navbar__Items').classList.remove('Navbar__ToggleShow');
}
...
document.querySelector('.Navbar__Link-toggle').addEventListener('click', Toggle_displayNav);